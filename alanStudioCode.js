intent("What does this app do?","What can i do here",reply('This is an news project Mukul'));

// intent("Start a command",(p)=>{
//     p.play({command:'testCommand'});
// })

const API_KEY = 'cef1e3a416054a149b6176a55fff231d';
let savedArticles = [];
...
intent('Give me the news from $(source* (.*))',(p)=>{
    ...
    api.request(NEWS_API_URL,(error,response,body)=>{
        ...
        p.play(`Here are some (latest|recent) ${p.source.value}.`);     
